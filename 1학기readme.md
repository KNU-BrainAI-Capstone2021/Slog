...
#자동로그인과 다운받고 싶은 이미지의 태그를 입력하여 첫페이지의 사진을 자동으로 다운받아 지정된 폴더에 "태그이름+숫자" 형태로 저장하기
...
[cnn학습.py](https://github.com/KNU-BrainAI-Capstone2021/Slog/blob/main/Old/cnn%ED%95%99%EC%8A%B5.py)|이미지의 CNN 학습|
[W2V.py](https://github.com/KNU-BrainAI-Capstone2021/Slog/blob/main/Old/W2V.py)|word embedding의 word2vec |
